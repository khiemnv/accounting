...
namespace test_binding
{
    ...
    public class lInputPanel : lSearchPanel
    {
        public lDataContent m_dataContent;
        public List<lSearchCtrl> m_inputsCtrls;

        public class PreviewEventArgs : EventArgs
        {
            public DataTable tbl;
        }
        public EventHandler<PreviewEventArgs> OnPreview;

        protected string m_tblName;
        protected new lTableInfo m_tblInfo { get { return appConfig.s_config.getTable(m_tblName); } }
        ...
        public override void initCtrls()
        {
            ...
            m_editBtn = lConfigMng.crtButton();
            m_editBtn.Text = "Edit";
            m_editBtn.Click += M_editBtn_Click;
            m_delBtn = lConfigMng.crtButton();
            m_delBtn.Text = "Remove";
            FlowLayoutPanel tflow = new FlowLayoutPanel();
            tflow.FlowDirection = FlowDirection.LeftToRight;
            tflow.Controls.AddRange(new Control[] { m_saveBtn, m_addBtn });
            tflow.Dock = DockStyle.Fill;
        ...
        protected virtual void Add()
        {
            ...
            if (OnPreview != null)
            {
                OnPreview(this, new PreviewEventArgs { tbl = tbl });
            }
        }
        private void M_saveBtn_Click(object sender, EventArgs e)
        {
            ...
            if (OnPreview != null)
            {
                OnPreview(this, new PreviewEventArgs { tbl = m_dataContent.m_dataTable });
            }
        }
        ...
        {
            {
                ...
                m_inputsCtrls = new List<lSearchCtrl> {
                    crtSearchCtrl(m_tblInfo, "receipt_number", new Point(0, 0), new Size(1, 1), lSearchCtrl.SearchMode.match),
                    crtSearchCtrl(m_tblInfo, "date", new Point(0, 1), new Size(1, 1)),
                    crtSearchCtrl(m_tblInfo, "name", new Point(0, 2), new Size(1, 1), lSearchCtrl.SearchMode.like),
                    crtSearchCtrl(m_tblInfo, "addr", new Point(0, 3), new Size(1, 1), lSearchCtrl.SearchMode.like),
                    crtSearchCtrl(m_tblInfo, "content", new Point(0, 4), new Size(1, 1), lSearchCtrl.SearchMode.match),
                    crtSearchCtrl(m_tblInfo, "note", new Point(0, 5), new Size(1, 1), lSearchCtrl.SearchMode.like),
                    crtSearchCtrl(m_tblInfo, "amount", new Point(0, 6), new Size(1, 1)),
                };
            }
        }
    }
